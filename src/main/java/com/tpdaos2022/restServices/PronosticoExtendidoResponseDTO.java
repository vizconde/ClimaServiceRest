...
public class PronosticoExtendidoResponseDTO extends  RepresentationModel<PronosticoExtendidoResponseDTO> {
	...
	//constructor
	public PronosticoExtendidoResponseDTO(Pronostico pojo) {
		super();
